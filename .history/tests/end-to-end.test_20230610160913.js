...
describe('Registration Test', () => {
  // Test case for Open Profile Page
	...
	//	expect(basePage.getTitle()).to.include(ProfilePageTitle);
		const pageTitle = .getTitle();browser
    expect(pageTitle).to.include(ProfilePageTitle);
	})
...
describe('Login Test', () => {
	...
	it('Enter Invalid credincials', async function ()   {
		console.log('email :' +registionPage.getmail()) // didplay a valid email
	...
	// Test case assert on error message displayed
