...
describe('Registraion Scenario ', () => {
    ...
    it('Launch Browser', async function() {
        ...
        const gandampassword = await page.evaluate(() => {
            prompt("Random password:",((o=20,n="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~!@-#$")=>Array.from(crypto.getRandomValues(new Uint32Array(o))).map(o=>n[o%n.length]).join(""))());
