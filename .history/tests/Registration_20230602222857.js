...
describe('Registraion Scenario ', () => {
    ...
    it('Launch Browser', async function() {
       ...
       // Password Generator
        ...
        const generatePassword = await page.evaluate(() => {
        = (length = 8) => { // password will be @Param-length, default to 8, and have at least one upper, one lower, one number and one symbol
            let pwd = "";
