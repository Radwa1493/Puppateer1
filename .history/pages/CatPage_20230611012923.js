...
export default class CatPage {
    ...
    //  await page.waitForTimeout(6000) //wait
     ...
     // const name2Element = await page.$(elements.ItemName2); 
      ...
      const  = await page.evaluate(name1Element => name1Element.textContent, name1Element); // get name2 in text
      const itemName1Text = await page.evaluate(itemNameElement => itemNameElement.textContent, itemNameElement);
