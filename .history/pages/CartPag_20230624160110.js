...
export default class CartPage extends Base {
  ...
  const elementExists = await page.evaluate(() => {
    return document.querySelector(elements.shipping) !== null;
  });
    ...
    const discount = await this.getText(page, elements.discount); // get  shipping in text
    ...
    console.log('Total actual Price: ' + Exprice4);
