...
export default class CatPage extends Base {
  ...
  async selectRandamCat() {
   ...
   const rand = 2 ; // select second category
...
//      await page.waitForSelector(elements.itemFav); // wait
    ...
    //  await page.click(elements.itemFav); //add to wish list
        ...
        await page.click(.addToCart__buttonContainer--infoBlock > button:nth-child(1)); // submit the form

/*
      const b = (await page.$x("(//button[contains(text(),'In den Warenkorb')])[1]"));
    b.click();
*/
