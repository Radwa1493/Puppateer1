...
export default class CatPage {
    ...
    //  await page.waitForTimeout(6000) //wait
      ...
      const name1 = await page.evaluate(Name1Element => priceElement.ItemName1, priceElement); // get name2 in text
      const name2 = await page.evaluate(Name2Element => priceElement.name2, Name2Element); // get name2 in text
