import { randamnum, postalcode } from '../config';
...
export default class CatPage extends Base {
  ...
  async selectRandamItem() {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      const e = await page.$$(elements.addtoCart); // add to cart
      await e[0].click();
      await this.wait(3000); // wait
    ...
    console.log('Expected Items: ' + Items);
