...
export default class CatPage {
    ...
    for (let i = 0; i < 5; i++) { //loop 5 times     
      ...
      const name1 = await page.evaluate(priceElement => priceElement.ItemName1, priceElement); // get price in text
      const name2 = await page.evaluate(priceElement => priceElement.ItemName1, priceElement); // get price in text
