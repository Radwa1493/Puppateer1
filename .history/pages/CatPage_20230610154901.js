...
export default class CatPage {
  ...
  //  await page.waitForSelector('div.wishlistIcon:nth-child(1)')
   ...
   // await page.waitForTimeout(3000)
    ...
    const text = await page.evaluate(priceElement => priceElement.textContent, priceElement); // get price 
    console.log(text);
    await page.click('.headerElement__icon--wishlist')//add to wish list
