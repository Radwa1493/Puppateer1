...
const elements = {
  ...
  addtoCart: '.addToCart__buttonContainer--infoBlock > button:nth-child(1)',
...
for (let i = 0; i < 2; i++) {
  ...
  await this.wait(4000);// wait
  if (await this.isElementDisplayed('#zipCodeOverlayInput')) {
  await page.type("#zipCodeOverlayInput", "10115"); // set zip
  await this.wait(4000);// wait
